...
<div style="margin-top:100px; margin-bottom: 32px;">
    <h2 style="margin-left: 20px; color: #53382c;"><strong>GIỎ HÀNG CỦA BẠN</strong></h2>
    <hr />
    ...
    <?php 
        if (isset($_SESSION['cart']) && count($_SESSION['cart']) > 0)
        {
            ...
            echo '</table>';
            echo '<div style="float:right; font-size: 24px; font-weight:bold; margin-right: 40px; color:red;">Tổng hóa đơn: '.$tongTatCa.'</div>';
            if ($tongSL < 2)
            {
                echo '<div style="margin-left: 20px; font-size: 15px; font-weight: bold;color:red;">Bạn cần mua ít nhất 2 ly để có thể tiến hành gửi đơn hàng.</div>';
            }
            else
            {
                echo '<br />
