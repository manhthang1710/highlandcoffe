    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-brown sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-brand d-flex align-items-center justify-content-center">
                ...
                <div class="sidebar-brand-text mx-3">Highland</div>
            </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-danger topbar mb-4 static-top shadow">
                    ...
                    <h2 style="color:#fff; margin-left: auto; font-weight:600">Highland Coffe</h2>
                    <!-- Topbar Navbar -->
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-white-700"><?php if (isset($_SESSION["user"])) echo $_SESSION["user"]["tenNV"]; ?></span>
                                <?php
                ...
                <footer class="sticky-footer bg-brown">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Đồ án cơ sở 2 &copy; <?php echo date('Y') ?>Trần Mạnh Thắng - Trần Văn Hiếu</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
