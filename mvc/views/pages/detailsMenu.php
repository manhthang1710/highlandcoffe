...
<div class="row" style="margin-top:100px">
    ...
    <div class="col-md-5 p-3" align="left">
        <h2 style="color:#53382c;"><strong><?php echo $data["du"]["TenDU"] ?></strong></h2>
        <!-- Begin Form -->
        <form class="form-addcart" name="form_addcart" id="form_addcart" action="Menu/AddToCart" method="post">
            ...
            <!--Chọn size-->
            <div class="size">
                <label style="font-size: 18px;color:#53382c">Size</label>
            ...
            <!--Chọn số lượng-->
            <div class="soluong">
                <label style="font-size: 18px;color:#53382c">Số lượng</label>
            ...
            <div class="ice-sugar">
                <div class="ice">
                    <label style="font-size: 18px;color:#53382c">ICE-%</label>
                    <div class="radio-ice">
                        <div class="block">
                ...
                <div class="sugar" style="margin-bottom: 20px;">
                    <label style="font-size: 18px;color:#53382c">SUGAR OR MILK-%</label>
            ...
            <!--Chọn món thêm-->
            <div class="monthem">
                <label style="font-size: 18px;color:#53382c">Món thêm</label>
                <table id="tpTable">
                    <?php
            ...
            <div>
                <br />
                <input type="submit" value="Thêm vào giỏ" class="btn-danger text-black" name="submitBtn" />
            </div>
            <br />
            <?php
