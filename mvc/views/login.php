...
<body style="background-image:url('public/images/bgrlogin.png');">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 style="font-family: 'Times New Roman', Times, serif;" class="h4 text-gray-900 mb-4">Đăng nhập</h1>
                                        </div>
                                        <?php
                                        ...
                                        <button type="submit" name="submit" class="btn btn-warning btn-user btn-block" style="font-family: 'Times New Roman', Times, serif;">Đăng nhập</button>
                                    </div>
                                </div>
                            </div>
                        </div>
